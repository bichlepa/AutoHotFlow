...
; ===============================================================================================================================
    ...
    __New()
    {
        ...
        this.hDC := DllCall("user32.dll\GetDC", "Ptr", 0, "Ptr") ;reinserted from old version of class_monitor
    }
...
; ===============================================================================================================================
    ...
    GetMonitorCapabilities(MonNum := 1)                                           ; http://msdn.com/library/dd692940(vs.85,en-us)
    {
        ...
        if !(DllCall(this._GetMonitorCapabilities, "Ptr", hMonitor, "UInt*", MonitorCapabilities, "UInt*", SupportedColorTemperatures))
            return "*" A_LastError
        MsgBox %SupportedColorTemperatures%
        SCT := Object()
...
; ===============================================================================================================================
    ...
    ;Reinserted from old version of class_monitor
    ; ===============================================================================================================================
