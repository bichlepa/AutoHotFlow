...
;~ temp=flow
;~ MsgBox % Rini_Create(temp,1)
;~ RIni_Read(temp,A_ScriptDir "\script.ini")
;~ RIni_SetKeyValue(temp, "general", "hello","xou")
;~ RIni_Write(temp, A_ScriptDir "\script2.ini")

;~ MsgBox % RIni_GetSectionKeys(temp, "general")
;~ MsgBox % RIni_GetKeyValue(temp, "general","name")
