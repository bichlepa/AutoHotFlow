...
init_Manager_GUI()
{
	...
	IL_Add(IconList, my_ScriptDir "\Icons\disabled.ico")
	Icon_Disabled:="icon1"
	IL_Add(IconList, my_ScriptDir "\Icons\enabled.ico")
	Icon_Enabled:="icon2"
	IL_Add(IconList, my_ScriptDir "\Icons\running.ico")
	Icon_Running:="icon3"
	IL_Add(IconList, my_ScriptDir "\Icons\folder.ico")
	Icon_Folder:="icon4"
	gui,manager:default
