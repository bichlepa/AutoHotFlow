...
global global_AllCustomBuiltInVars:=" A_YWeek a_linefeed a_lf a_cr a_carriageReturn a_workingdir A_LanguageName a_NowString a_flowName a_flowID a_elementName a_elementID A_AhfVersion "
...
BuiltInVariable_Get(Environment, p_Name, p_hidden = False)
{
	...
	else if (p_Name = "A_AhfVersion")
	{
		return _getShared("AhfVersion")
	}
