...
var_EvaluateExpressionRecurse(environment,ExpressionString, func_GetVariable)
{
	...
	if (var_SearchForFirstOperand(ExpressionString,FoundOpreand,leftSubstring,rightSubstring))
	{
...
var_SearchForFirstOperand(String,ByRef ResFoundoperand,Byref ResLeftString, Byref ResRightString)
{
	BracketCount=0
	firstplus=
	firstminus=
