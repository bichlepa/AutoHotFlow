...
Element_getParametrizationDetails_Condition_List_Contains_Element(Environment)
{
	...
	parametersToEdit.push({type: "Radio", id: "SearchWhat", default: 2, choices: [x_lang("Search for a position or key"), x_lang("Search for an element with a specified content")], result: "enum", enum: ["Key", "Content"]})
