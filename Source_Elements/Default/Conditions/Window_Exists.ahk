...
Element_getParametrizationDetails_Condition_Window_Exists(Environment)
{
	...
	parametersToEdit.push({type: "button", goto: "Condition_Window_Exists_ButtonWindowAssistant", label: lang("Import window identification")})
...
Element_GenerateName_Condition_Window_Exists(Environment, ElementParameters)
{
	...
	return lang("Window_Exists") ": " tempNameString
}
