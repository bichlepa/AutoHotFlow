...
x_RegisterElementClass("Condition_Window_Exists")

;Element type of the element
Element_getElementType_Condition_Window_Exists()
{
	return "Condition"
}
...
Element_getPackage_Condition_Window_Exists()
{
	return "default"
}
...
Element_getParametrizationDetails_Condition_Window_Exists(Environment)
{
	...
	parametersToEdit.push({type: "button", goto: "Condition_Window_Exists_ButtonWindowAssistant", label: x_lang("Import window identification")})
...
Element_GenerateName_Condition_Window_Exists(Environment, ElementParameters)
{
	...
	return x_lang("Window_Exists") ": " tempNameString
}
...
Element_CheckSettings_Condition_Window_Exists(Environment, ElementParameters)
{	
