...
Element_getElementLevel_Trigger_Window_Gets_Inactive()
{
...
Element_getStabilityLevel_Trigger_Window_Gets_Inactive()
{
...
Element_GenerateName_Trigger_Window_Gets_Inactive(Environment, ElementParameters)
{
	...
	return x_lang("Window_Gets_Inactive") ": " nameString
...
Element_CheckSettings_Trigger_Window_Gets_Inactive(Environment, ElementParameters, staticValues)
{	
...
Element_enable_Trigger_Window_Gets_Inactive(Environment, ElementParameters)
{
	...
	functionObject := x_NewFunctionObject(environment, "Trigger_Window_Gets_Inactive_TimerLabel", EvaluatedParameters, EvaluatedWindowParameters, [])
...
Element_postTrigger_Trigger_Window_Gets_Inactive(Environment, ElementParameters, TriggerData)
{
...
Trigger_Window_Gets_Inactive_TimerLabel(Environment, EvaluatedParameters, EvaluatedWindowParameters, staticData, fistCall = false)
{
	...
	{
		if ((windowID != staticData.currentWindowID) and staticData.currentWindowID)
		{
			...
			x_trigger(Environment, {windowID: staticData.currentWindowID})
		}
