...
x_RegisterElementClass("Trigger_Window_Opens")
...
Element_getParametrizationDetails_Trigger_Window_Opens(Environment)
{
	...
	parametersToEdit.push({type: "button", goto: "Trigger_Window_Opens_ButtonWindowAssistant", label: x_lang("Get_Parameters")})
...
Element_GenerateName_Trigger_Window_Opens(Environment, ElementParameters)
{
	...
	return x_lang("Window_Opens") ": " tempNameString
}
...
Element_enable_Trigger_Window_Opens(Environment, ElementParameters)
{
	...
	functionObject := x_NewFunctionObject(environment, "Trigger_Window_Opens_TimerLabel", EvaluatedParameters)
...
Trigger_Window_Opens_ButtonWindowAssistant()
{
...
Trigger_Window_Opens_TimerLabel(Environment, parameters, fistCall = false)
{
