...
Element_enable_Trigger_Window_Opens(Environment, ElementParameters)
{
	...
	inputVars:={winstring: tempwinstring, wintext: tempWinText, titlematchmode: tempTitleMatchMode, findhiddenwindow: tempFindHiddenWindows, findhiddentext: tempfindhiddentext, NotTriggerOnEnable: ElementParameters.NotTriggerOnEnable}
	outputVars:=["windowID"]
	code =
	( ` , LTrim %
