...
Element_getParametrizationDetails_Trigger_Window_Closes(Environment)
{
	...
	parametersToEdit.push({type: "button", goto: "Trigger_Window_Closes_ButtonWindowAssistant", label: x_lang("Get_Parameters")})
...
Element_GenerateName_Trigger_Window_Closes(Environment, ElementParameters)
{
	...
	return x_lang("Window_Closes") ": " tempNameString
}
