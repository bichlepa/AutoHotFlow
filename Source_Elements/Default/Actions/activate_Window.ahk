...
x_RegisterElementClass("Action_Activate_Window")
...
Element_getStabilityLevel_Action_Activate_Window()
{
...
{	
	...
	parametersToEdit.push({type: "button", goto: "Action_Activate_Window_ButtonWindowAssistant", label: x_lang("Get_Parameters")})
...
Element_GenerateName_Action_Activate_Window(Environment, ElementParameters)
{
	...
	return x_lang("Activate_Window") ": " tempNameString
...
Element_stop_Action_Activate_Window(Environment, ElementParameters)
{
	
}

; opens the assistant for getting window information
Action_Activate_Window_ButtonWindowAssistant()
{
