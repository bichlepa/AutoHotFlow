...
Element_getParametrizationDetails_Action_Close_Window(Environment)
{
	...
	parametersToEdit.push({type: "button", goto: "Action_Close_Window_ButtonWindowAssistant", label: x_lang("Import window identification")})
	
	parametersToEdit.push({type: "Label", label: x_lang("Method")})
	parametersToEdit.push({type: "Radio", id: "WinCloseMethod", default: 1, choices: [x_lang("Close"), x_lang("Kill")]})
...
Element_GenerateName_Action_Close_Window(Environment, ElementParameters)
{
	...
	return x_lang("Close_Window") ": " tempNameString
}
