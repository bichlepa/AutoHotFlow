...
Element_getParametrizationDetails_Action_Substring(Environment)
{
	...
	parametersToEdit.push({type: "Radio", id: "WhereToBegin", default: "FromLeft", choices: [x_lang("Start from left"), x_lang("Start from right"), x_lang("Start from following position")], result: "enum", enum: ["FromLeft", "FromRight", "Position"]})
