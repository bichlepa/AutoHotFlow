...
AllElementClasses.push("Action_Show_Window")
...
Element_getParametrizationDetails_Action_Show_Window(Environment)
{
	...
	parametersToEdit.push({type: "button", goto: "Action_Show_Window_ButtonWindowAssistant", label: lang("Import window identification")})
...
Element_GenerateName_Action_Show_Window(Environment, ElementParameters)
{
	...
	return lang("Show_Window") ": " tempNameString
}
