...
AllElementClasses.push("Action_Delete_File")
...
Element_getParametrizationDetails_Action_Delete_File(Environment)
{
	...
	parametersToEdit.push({type: "Radio", id: "deleteFileMethod", default: 1, choices: [lang("Delete"), lang("Recycle")]})
...
Element_run_Action_Delete_File(Environment, ElementParameters)
{
	...
	else if (deleteFileMethod = 2) ;Recycle
	{
		FileRecycle, % file
		if errorlevel ;Indecates that files could not be copied
		{
