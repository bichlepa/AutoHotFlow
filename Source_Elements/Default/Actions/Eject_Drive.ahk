...
AllElementClasses.push("Action_Eject_Drive")
...
Element_getParameters_Action_Eject_Drive()
{
	parametersToEdit:=Object()
	
	parametersToEdit.push({id: "DriveLetter"})
	parametersToEdit.push({id: "WhatDo"})
...
Element_CheckSettings_Action_Eject_Drive(Environment, ElementParameters)
{	
