...
x_RegisterElementClass("Action_Get_shortcut_information")

;Element type of the element
Element_getElementType_Action_Get_shortcut_information()
{
	return "Action"
}
...
Element_getPackage_Action_Get_shortcut_information()
{
	return "Default"
}
