...
x_RegisterElementClass("Action_Set_control_text")

;Element type of the element
Element_getElementType_Action_Set_control_text()
{
	return "Action"
}
...
Element_getPackage_Action_Set_control_text()
{
	return "default"
}
...
Element_getParametrizationDetails_Action_Set_control_text(Environment)
{
	...
	parametersToEdit.push({type: "button", goto: "Action_Set_control_text_ButtonWindowAssistant", label: x_lang("Import window identification")})
...
Element_GenerateName_Action_Set_control_text(Environment, ElementParameters)
{
	...
	return x_lang("Set_control_text") ": " tempNameString
}
...
Element_CheckSettings_Action_Set_control_text(Environment, ElementParameters)
{	
