...
Element_getParametrizationDetails_Action_Set_control_text(Environment)
{
	...
	parametersToEdit.push({type: "button", goto: "Action_Set_control_text_ButtonWindowAssistant", label: lang("Import window identification")})
...
Element_GenerateName_Action_Set_control_text(Environment, ElementParameters)
{
	...
	return lang("Set_control_text") ": " tempNameString
}
