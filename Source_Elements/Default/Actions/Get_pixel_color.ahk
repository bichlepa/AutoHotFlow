...
AllElementClasses.push("Action_Get_Pixel_Color")
...
Element_getParameters_Action_Get_Pixel_Color()
{
	parametersToEdit:=Object()
	
	parametersToEdit.push({id: "OutputRGB"})
	parametersToEdit.push({id: "OutputSeparate"})
	parametersToEdit.push({id: "varnameRGB"})
	parametersToEdit.push({id: "varnameR"})
	parametersToEdit.push({id: "varnameG"})
	parametersToEdit.push({id: "varnameB"})
	parametersToEdit.push({id: "CoordMode"})
	parametersToEdit.push({id: "CoordinateX"})
	parametersToEdit.push({id: "CoordinateY"})
...
Element_getParametrizationDetails_Action_Get_Pixel_Color(Environment)
{
	...
	parametersToEdit.push({type: "Radio", id: "CoordMode", default: 1, result: "enum", choices: [lang("Relative to screen"), lang("Relative to active window position"), lang("Relative to active window client position")], enum: ["Screen", "Window", "Cilent"]})
