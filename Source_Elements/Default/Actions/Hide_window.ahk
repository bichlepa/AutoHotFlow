...
x_RegisterElementClass("Action_Hide_Window")
...
Element_getParametrizationDetails_Action_Hide_Window(Environment)
{
	...
	parametersToEdit.push({type: "button", goto: "Action_Hide_Window_ButtonWindowAssistant", label: x_lang("Import window identification")})
...
Element_GenerateName_Action_Hide_Window(Environment, ElementParameters)
{
	...
	return x_lang("Hide_Window") ": " tempNameString
}
