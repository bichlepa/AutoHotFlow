...
runLoopLoop_through_files(InstanceID,ThreadID,ElementID,ElementIDInInstance,HeadOrTail)
{
	...
	if HeadOrTail=Head ;Initialize loop
	{
		...
		{
			v_SetVariable(InstanceID,ThreadID,"A_LoopCurrentList",tempFiles,,true)
			v_SetVariable(InstanceID,ThreadID,"A_Index",1,,true)
			
			tempOneFile:=tempFiles[1]
			tempFiles.remove(1)
			v_SetVariable(InstanceID,ThreadID,"A_LoopFileName",tempOneFile["A_LoopFileName"],,true)
			v_SetVariable(InstanceID,ThreadID,"A_LoopFileExt",tempOneFile["A_LoopFileExt"],,true)
			v_SetVariable(InstanceID,ThreadID,"A_LoopFileFullPath",tempOneFile["A_LoopFileFullPath"],,true)
			v_SetVariable(InstanceID,ThreadID,"A_LoopFileLongPath",tempOneFile["A_LoopFileLongPath"],,true)
			v_SetVariable(InstanceID,ThreadID,"A_LoopFileShortPath",tempOneFile["A_LoopFileShortPath"],,true)
			v_SetVariable(InstanceID,ThreadID,"A_LoopFileShortName",tempOneFile["A_LoopFileShortName"],,true)
			v_SetVariable(InstanceID,ThreadID,"A_LoopFileDir",tempOneFile["A_LoopFileDir"],,true)
			v_SetVariable(InstanceID,ThreadID,"A_LoopFileTimeModified",tempOneFile["A_LoopFileTimeModified"],,true)
			v_SetVariable(InstanceID,ThreadID,"A_LoopFileTimeCreated",tempOneFile["A_LoopFileTimeCreated"],,true)
			v_SetVariable(InstanceID,ThreadID,"A_LoopFileTimeAccessed",tempOneFile["A_LoopFileTimeAccessed"],,true)
			v_SetVariable(InstanceID,ThreadID,"A_LoopFileAttrib",tempOneFile["A_LoopFileAttrib"],,true)
			v_SetVariable(InstanceID,ThreadID,"A_LoopFileSize",tempOneFile["A_LoopFileSize"],,true)
			v_SetVariable(InstanceID,ThreadID,"A_LoopFileSizeKB",tempOneFile["A_LoopFileSizeKB"],,true)
			v_SetVariable(InstanceID,ThreadID,"A_LoopFileSizeMB",tempOneFile["A_LoopFileSizeMB"],,true)
			v_SetVariable(InstanceID,ThreadID,"A_LoopFileNameNoExt",tempOneFile["A_LoopFileNameNoExt"],,true)
