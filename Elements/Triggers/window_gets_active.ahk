iniAllTriggers.="Window_Gets_Active|" ;Add this trigger to list of all triggers on initialisation

EnableTriggerWindow_Gets_Active(ElementID)
{
	...
	;~ MsgBox % ErrorLevel
	TriggerWindow_Gets_Active%ElementID%["ahkpid"]:=tempPID
	
}

DisableTriggerWindow_Gets_Active(ElementID)
{
	global
	DetectHiddenWindows, On
	;Three different methods to terminate the trigger
	winclose,% TriggerWindow_Gets_Active%ElementID%["Title"] "§" CurrentManagerHiddenWindowID "§"
	com_SendCommand({function: "exit"},"custom",TriggerWindow_Gets_Active%ElementID%["Title"] "§" CurrentManagerHiddenWindowID "§")
	Process,close,% TriggerWindow_Gets_Active%ElementID%["ahkpid"]
...
{
	tempNameString:=lang("Window_Gets_Active") " - "
...
goto,jumpOverTriggerWindow_Gets_ActiveGetParameters


TriggerWindow_Gets_ActiveGetParameters:
...
jumpOverTriggerWindow_Gets_ActiveGetParameters:
temp:=temp
