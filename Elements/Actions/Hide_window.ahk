iniAllActions.="Hide_window|" ;Add this action to list of all actions on initialisation

runActionHide_window(InstanceID,ThreadID,ElementID,ElementIDInInstance)
{
	global
	local tempWinid
...
getNameActionHide_window()
{
	return lang("Hide_window")
}
getCategoryActionHide_window()
{
	return lang("Window")
}
getParametersActionHide_window()
{
	
	parametersToEdit:=["Label|" lang("Title_of_Window"),"Radio|1|TitleMatchMode|" lang("Start_with") ";" lang("Contain_anywhere") ";" lang("Exactly"),"text||Wintitle","Label|" lang("Exclude_title"),"text||excludeTitle","Label|" lang("Text_of_a_control_in_Window"),"text||winText","Checkbox|0|FindHiddenText|" lang("Detect hidden text"),"Label|" lang("Exclude_text_of_a_control_in_window"),"text||ExcludeText","Label|" lang("Window_Class"),"text||ahk_class","Label|" lang("Process_Name"),"text||ahk_exe","Label|" lang("Unique_window_ID"),"text||ahk_id","Label|" lang("Unique_Process_ID"),"text||ahk_pid","Label|" lang("Get_parameters"), "button|FunctionsForElementGetWindowInformation||" lang("Get_Parameters")]
	
	
	return parametersToEdit
}

GenerateNameActionHide_window(ID)
{
	global
	
	tempNameString:=lang("Hide_window")
