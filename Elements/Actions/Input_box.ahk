...
runActionInput_box(InstanceID,ElementID,ElementIDInInstance)
{
	global
	...
	for count, tempcInput_boxidToStart in ActionInput_boxToStart ;get the first element
	{
		...
		ActionInput_boxToStart_Element_ID:=tempElement3
		...
		gui,12:add,text,x10 w320 h100, % v_replaceVariables(InstanceID,%ActionInput_boxToStart_Element_ID%text,"normal")
		...
		gui,12:show,w330 h180 ,% v_replaceVariables(InstanceID,%ActionInput_boxToStart_Element_ID%title,"normal")
		
		ActionInput_boxStart_Current:=tempcInput_boxidToStart
		ActionInput_boxStart_CurrentInstanceID:=InstanceID
	...
	v_setVariable(ActionInput_boxStart_CurrentInstanceID,"t_input",ActionInput_box_edit)
