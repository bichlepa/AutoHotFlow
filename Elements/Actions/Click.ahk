...
{
	global
	parametersToEdit:=["Label|" lang("Whitch button"), "DropDownList|1|Button|" lang("Left button") ";" lang("Right button") ";" lang("Middle Button") ";" lang("Wheel up") ";" lang("Wheel down") ";" lang("Wheel left") ";" lang("Wheel right") ";" lang("4th mouse button (back)") ";" lang("5th mouse button (forward)"),"Label|" lang("Click count"),"Text||ClickCount","Label|" lang("Event"),"Radio|1|DownUp|" lang("Click (Down and up)") ";" lang("Keep down") ";" lang("Release only"),"Label|" lang("Mouse position"),"Checkbox|0|changePosition|" lang("Move mouse before clicking"),"Radio|1|CoordMode|"  lang("Relative to screen") ";" lang("Relative to active window position") ";" lang("Relative to active window client position") ";" lang("Relative to current mouse position"),"Label|" lang("Coordinates") " " lang("(x,y)"),"Text2|10;20|Xpos;Ypos","Label|" lang("Method"),"Radio|1|SendMode|" lang("Input mode") ";" lang("Event mode") ";" lang("Play mode"),"Label|" lang("Speed"),"Slider|2|speed|Range0-100 tooltip"]
