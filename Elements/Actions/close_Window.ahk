...
runActionClose_window(InstanceID,ElementID,ElementIDInInstance)
{
	global
	...
	{
		Winclose,%tempwinstring%,%tempWinText%,%tempExcludeTitle%,%tempExcludeText%
...
GenerateNameActionClose_window(ID)
{
	...
	tempNameString:=lang("Close_Window")
